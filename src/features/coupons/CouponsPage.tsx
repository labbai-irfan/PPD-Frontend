        ...
        {isPending
          ...
          : data?.map((coupon) => (
              <Card key={coupon.code} className="flex items-stretch overflow-hidden">
                ...
                <div className="min-w-0 flex-1 border-l border-dashed border-border p-4">
                  ...
                  <h3 className="mt-2 text-sm font-bold break-words text-foreground">{coupon.title}</h3>
                  <p className="mt-0.5 text-xs break-words text-muted-foreground">{coupon.description}</p>
                ...
                <button
                  ...
                  className="flex min-h-11 shrink-0 items-center gap-1.5 self-center px-4 py-3 text-sm font-bold text-primary transition-opacity hover:opacity-75 cursor-pointer"
                >
