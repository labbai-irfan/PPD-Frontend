  ...
  return (
    <div className="rounded-2xl bg-card p-3.5 shadow-card">
      <div className="flex gap-3">
        <div className="size-[58px] shrink-0 overflow-hidden rounded-[10px] bg-surface-placeholder dark:bg-muted">
          {first && <img src={first.image} alt="" className="size-full object-cover" />}
        </div>
